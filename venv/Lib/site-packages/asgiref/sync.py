...
class AsyncToSync:
    ...
    def __call__(self, *args, **kwargs):
        ...
        # apps event loop's thread if it's there, otherwise make a new loop
        # in this thread.
        try:
...
class SyncToAsync:
    ...
    outermost), this will just be the apps thread. This is achieved by idling
    ...
    # Storage for apps event loop references
